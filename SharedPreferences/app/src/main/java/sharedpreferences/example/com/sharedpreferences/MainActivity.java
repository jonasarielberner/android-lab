package sharedpreferences.example.com.sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoNome = (EditText) findViewById(R.id.editTextId);
        textoExibicao = (TextView) findViewById(R.id.textViewId);
        botaoSalvar = (Button) findViewById(R.id.buttonSaveId);
        ...
        botaoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(textoNome.getText().toString().equals("")){
                    ...
                    editor.putString("Olá, ", textoNome.getText().toString());
                    editor.commit();
